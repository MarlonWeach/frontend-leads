-- Script para corrigir avisos de search_path mutável
...
FROM pg_proc 
WHERE proname IN (
    'update_adset_goals_updated_at',
    'update_ad_creatives_updated_at',
    'trigger_update_alert_stats',
    'validate_budget_adjustment_frequency',
    'get_budget_adjustment_stats',
    'should_suppress_alert',
    'get_active_alerts_for_adset',
    'update_alert_stats',
    'update_cache_stats_updated_at'
)
ORDER BY proname; 