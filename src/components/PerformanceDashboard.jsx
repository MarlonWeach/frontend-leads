    ...
    <div className="p-6 space-y-8">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm text-gray-400 mb-2">Impressões</p>
              <p className="text-2xl font-bold text-white">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm text-gray-400 mb-2">Cliques</p>
              <p className="text-2xl font-bold text-white">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm text-gray-400 mb-2">Leads Gerados</p>
              <p className="text-2xl font-bold text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="text-center">
            <p className="text-sm text-gray-400 mb-3">CPC (Custo por Clique)</p>
            <p className="text-2xl font-bold text-white">
        ...
        <Card className="p-6">
          <div className="text-center">
            <p className="text-sm text-gray-400 mb-3">CPM (Custo por Mil)</p>
            <p className="text-2xl font-bold text-white">
        ...
        <Card className="p-6">
          <div className="text-center">
            <p className="text-sm text-gray-400 mb-3">Taxa de Conversão</p>
            <p className="text-2xl font-bold text-white">
      ...
      <Card className="p-6">
        <LineChartAnimated 
          ...
          width={800} 
          height={400} 
          title="Tendências de Performance (Últimos 7 dias)"
        />
      </Card>
    </div>
  );
