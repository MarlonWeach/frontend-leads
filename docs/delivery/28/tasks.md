...
| 28-16 | Corrigir defasagem e ordenação do heatmap de performance | InProgress | Ajustar timezone (America/Sao_Paulo) e ordenação diária do heatmap para eliminar deslocamento D-1 observado entre dashboard e Meta |
